<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="StudentInvoiceEdit.aspx.cs" Inherits="StudentInvoice" %>
                ...
                <div class="form-container">
                    ...
                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnBatch" runat="server" Text=" Generate Invoice" CssClass="btn-primary" OnClick="btnBatch_Click" />
                         <asp:Button ID="btnEditInvoice" runat="server" Text=" Back" CssClass="btn-secondary" OnClick="btnEditInvoice_Click" />
                    </div>
