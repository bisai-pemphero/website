        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">View Invoices</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnBatch" runat="server" Text=" Generate Invoice" CssClass="btn-primary" OnClick="btnBatch_Click" />
                         <asp:Button ID="btnEditInvoice" runat="server" Text=" Edit Invoice" CssClass="btn-secondary" OnClick="btnEditInvoice_Click" />
                    </div>
