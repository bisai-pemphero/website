...
public partial class UsersView : System.Web.UI.Page
{
    ...
    public void LoadStaff()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            SqlCommand command = new SqlCommand(@"Select U.[UserId], U.[Username], 
                U.[Fullname], R.RoleName, AL.School_name
                from [Users] as U Join AllSchools as AL on U.SchoolId = AL.SchoolId
                Join Roles as R on R.RoleId = U.RoleId where U.SchoolId = @schoolId 
                AND U.RoleId != 1 AND U.RoleId != 2", connection);
            ...
            while (reader.Read())
            {
                ...
                Response.Write("<a href='UserEdit.aspx?userId=" + Id + "' class='btn btn-warning'>");
