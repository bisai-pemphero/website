...
<body>
    <form id="form1" runat="server">
                ...
                <nav class="nav">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="FeesCategory.aspx">Fees Category</a>
                        </div>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="UsersView.aspx">Manage Users</a>
            ...
            <div>
                ...
                <main class="content">
                    <section class="details-grid">
                        ...
                        <!-- Fees Summary -->
                        <article class="card">
                            <div class="card-header"><i class="fa-solid fa-chart-pie"></i>Overall Fees Summary</div>
                            <div class="card-body">
                                ...
                                <div class="summary-cards">
                                    <div class="summary-card expected">
                                        ...
                                        <div class="card-content">
                                            <div class="card-value">
                                                <asp:Label runat="server" ID="lblOverallExpected"></asp:Label>
                                            </div>
                                    ...
                                    <div class="summary-card collected">
                                        ...
                                        <div class="card-content">
                                            <div class="card-value">
                                                <asp:Label runat="server" ID="lblOverallCollected"></asp:Label>
                                            </div>
                                    ...
                                    <div class="summary-card balance">
                                        ...
                                        <div class="card-content">
                                            <div class="card-value">
                                                <asp:Label runat="server" ID="lblOverallBalance"></asp:Label>
                                            </div>
                                ...
                                <div class="chart-grid">
                                    <div class="chart-container">
                                        <div class="chart-title">Collection by Class</div>
                                        <div class="chart-wrapper">
                                            <canvas id="chartOverallClass"></canvas>
                                        </div>
                                    </div>
                                    <div class="chart-container">
                                        <div class="chart-title">Collection by Category</div>
                                        <div class="chart-wrapper">
                                            <canvas id="chartOverallCategory"></canvas>
                                        </div>
                                    </div>
                                </div>

                                <div class="summary-stats" id="overallClassStats" runat="server">
                            ...
                            <div class="card-body">
                                ...
                                <div class="summary-card collected">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="card-label">Total Collected Today</div>
                                    </div>
                                    <div class="card-badge success">
                                        <i class="fa-solid fa-check"></i>
                                    </div>
                        ...
                        <article class="card">
                            ...
                            <div class="chart-grid">
                                ...
                                <div class="chart-container">
                                    <div class="chart-title">Student by Class</div>
                                    <div class="chart-wrapper">
        ...
        datasets: [{
            ...
            const overallClassCtx = document.getElementById('chartOverallClass').getContext('2d');
            const overallClassData = <%= ChartOverallClassData %>;
            new Chart(overallClassCtx, {
                type: 'pie',
            ...
            const overallCategoryCtx = document.getElementById('chartOverallCategory').getContext('2d');
            const overallCategoryData = <%= ChartOverallCategoryData %>;
            new Chart(overallCategoryCtx, {
                type: 'pie',
