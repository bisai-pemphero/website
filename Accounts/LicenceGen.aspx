<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LicenceGen.aspx.cs" Inherits="LicenceGen" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="LicenceGen.aspx">Generate Licence</a>
                </div>
                <div class="form-container">
                    <h2 class="form-header">School Licences</h2>
                                    ...
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            <asp:LinkButton ID="btnView" runat="server" CommandName="View" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="View Licence" OnClientClick='<%# "showSchoolDetails(\"" + Eval("SchoolId") + "\"); return false;" %>'>
                                                    <i class="fas fa-eye"></i>
                                            </asp:LinkButton>

                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Add" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Generate Licence">
