    ...
    public void LoadStudents()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            SqlCommand command = new SqlCommand(@"Select S.StudentID, S.[FirstName], 
	            ...
	            where S.[IsDeleted] = 1 and S.SchoolId = @schoolId", connection);
            ...
            while (reader.Read())
            {
                ...
                Response.Write("<a href='EditStudentRecover.aspx?studentId=" + Id + "' class='btn btn-warning'>");
                Response.Write("<i class='fas fa-recycle'></i></a>");
                Response.Write("</td>");
