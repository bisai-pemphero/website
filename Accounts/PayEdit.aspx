<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayEdit.aspx.cs" Inherits="Fees" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-4">
                    <div class="card p-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList CssClass="form-control" ID="drpcashcheque" runat="server">
                                        <asp:ListItem Text="" Value=""></asp:ListItem>
                                         <asp:ListItem Text="Cash" Value="Cash"></asp:ListItem>
                                         <asp:ListItem Text="Bank Deposit" Value="Bank Deposit"></asp:ListItem>
                                         <asp:ListItem Text="Mobile Money" Value="Mobile Money"></asp:ListItem>
                        ...
                        <!-- Buttons -->
                        <div class="mt-4">
                            <asp:Button runat="server" ID="btnSave" Text="Update Transaction" CssClass="btn btn-success me-2"  OnClientClick="return validateForm();" OnClick="btnSave_Click" />
                            <asp:Button runat="server" ID="btnDelete" Text="Delete Transaction" CssClass="btn btn-danger me-2" OnClick="btnDelete_Click"/>
                            <asp:Button runat="server" ID="btnBack" Text="Back" CssClass="btn btn-secondary m-2" OnClick="btnBack_Click" />
                        </div>
                    </div>
                </div>
