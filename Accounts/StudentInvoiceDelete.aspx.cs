...
public partial class StudentInvoiceCreate : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //Insert into Student
            string sql4 = @"DELETE F
            FROM Fees AS F
            JOIN Students AS S ON F.studentId = S.StudentID
            WHERE F.fees_Category = @feesCategory
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ShowSuccess", "showAlert('success', 'Class Invoice Deleted Successfully!', 'StudentInvoice.aspx');", true);
        }
        catch (Exception ex)
        {
