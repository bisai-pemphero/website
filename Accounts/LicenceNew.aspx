<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LicenceNew.aspx.cs" Inherits="LicenceNew" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="LicenceNew.aspx">New Licence</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Generate New Licence</h2>
                    ...
                    <div class="form-grid">
                        <!-- Start date -->
                        <div class="form-group">
                            <label class="form-label" for="txtAddress">Start Date</label>
                            <div class="input-with-icon">
                                <i class="fas fa-calendar"></i>
                                <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                            </div>
                            <div class="error-message" id="updated-error">Please enter start date</div>
                        </div>

                        <!-- End Date -->
                        <div class="form-group">
                            <label class="form-label" for="txtExpiry">Expiry Date</label>
                            <div class="input-with-icon">
                                <i class="fas fa-calendar"></i>
                                <asp:TextBox ID="txtExpiryDate" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                            </div>
                            <div class="error-message" id="expiry-error">Please enter Licence Expiry Date</div>
                        </div>
                    </div>
                    <div class="form-grid">
                        <!-- School Address -->
                        <div class="form-group">
                            <label class="form-label" for="txtAddress">Licence Category</label>
                            <div class="input-with-icon">
                                <i class="fas fa-folder"></i>
                                <asp:DropDownList runat="server" ID="drpCategory" CssClass="form-control"></asp:DropDownList>
                    ...
                    <div class="button-container">
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Save Licence" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                ...
                <asp:Label runat="server" ID="lblAdminName" Visible="false"></asp:Label>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtStartDate.ClientID%>').value.trim()) {
                    document.getElementById('updated-error').style.display = 'block';
                    isValid = false;
                }

                if (!document.getElementById('<%= txtExpiryDate.ClientID %>').value.trim()) {
                    document.getElementById('expiry-error').style.display = 'block';
                    isValid = false;
                }

                if (!document.getElementById('<%= drpCategory.ClientID %>').value.trim()) {
