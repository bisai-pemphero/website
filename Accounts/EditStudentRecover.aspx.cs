...
public partial class AddStudent : System.Web.UI.Page
{
    ...
    public void LoadStudentDetails()
    {
        try
        {
            ...
            while (dr.Read())
            {
                ...
                {
                    ddlCurrentClass.SelectedIndex = dr.GetInt32(6);
                }
                ...
                {
                    ddlPreviousClass.SelectedIndex = dr.GetInt32(7);
                }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //update Student
            string sql4 = @"Update Students set [IsDeleted] = 0, 
        [UpdatedAt] = GETDATE() where [StudentID] = @studentId";
            ...
            cmd4.Parameters.AddWithValue("@studentId", lblStudentId.Text.Trim());
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "ShowSuccess", "showAlert('success', 'Student Restored successfully!', 'ViewStudent.aspx');", true);    
        }
        catch (Exception ex)
        {
