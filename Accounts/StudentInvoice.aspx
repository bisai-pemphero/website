<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="StudentInvoice.aspx.cs" Inherits="StudentInvoice" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="StudentInvoice.aspx">Student Invoice</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Fees Payment</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                          <asp:Button ID="btnOld" runat="server" Text="All Terms" CssClass="btn-secondary" OnClick="btnOld_Click"/>
                         <asp:Button ID="btnEditInvoice" runat="server" Text=" Delete Class Invoice" CssClass="btn-primary" OnClick="btnEditInvoice_Click" />
                         <asp:Button ID="btnStudentDelete" runat="server" Text="Delete Student Invoice" CssClass="btn-secondary" OnClick="btnStudentDelete_Click"/>
                    </div>
