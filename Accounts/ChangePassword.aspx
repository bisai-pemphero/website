<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="ChangingPassword" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a>Update Password</a>
                </div>
                ...
                <div class="form-container">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="action">Fullname</label>
                            <div class="input-with-icon">
                                <i class="fas fa-user"></i>
                               
                                <asp:TextBox CssClass="form-control" placeholder="Fullname" ID="txtFullname" runat="server" Enabled="false"></asp:TextBox>
                            </div>
                        ...
                        <!-- Class Name -->
                        <div class="form-group">
                            <label class="form-label" for="class">Current Password</label>
                            <div class="input-with-icon">
                                <i class="fas fa-lock"></i>
                               <asp:TextBox CssClass="form-control" placeholder="Current Password" ID="txtCurrentPassword" runat="server"></asp:TextBox>
                            </div>
                            <div class="error-message" id="currentPassword-error">Please enter Current Password</div>
                        </div>

                       
                        <div class="form-group">
                            <label class="form-label" for="Level">New Password</label>
                            <div class="input-with-icon">
                                <i class="fas fa-key"></i>
                                    <asp:TextBox CssClass="form-control" placeholder="New Password" ID="txtNewPassword" runat="server" ></asp:TextBox>
                            </div>
                            <div class="error-message" id="newPassword-error">Please enter New Password</div>
                        </div>
                    </div>

                    <div class="button-container">
                        <asp:Button runat="server" ID="btnRegister" CssClass="btn-primary" Text="Update Password" OnClientClick="return validateForm()" OnClick="btnRegister_Click" />
        ...
        <script>
            ...
            function validateForm() {
                ...
                document.getElementById('<%= txtCurrentPassword.ClientID %>').addEventListener('change', function () {
