<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BulkReceipt.aspx.cs" Inherits="StudentInvoice" %>
...
<body>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">BULK RECEIPT</h2>
    ...
    <div class="filter-item">
        <div class="form-group">
            ...
            <asp:TextBox CssClass="form-control" runat="server" ID="txtDate" TextMode="Date"></asp:TextBox>
    ...
    <div class="filter-actions">
        <asp:Button ID="btnPrint" runat="server" Text="Print Receipts" CssClass="btn btn-primary" OnClick="btnPrint_Click" OnClientClick="return validateForm()"/>
