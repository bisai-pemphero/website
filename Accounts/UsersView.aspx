<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="UsersView.aspx.cs" Inherits="UsersView" %>
        ...
        <div class="app">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <nav class="nav">
                    ...
                    <div class="dropdown">
                        <a class="active" href="#"><i class="fa-solid fa-user"></i>Users</a>
                        <div class="dropdown-menu">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">View Users</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnAddUser" runat="server" Text=" Add User" Font-Bold="true" CssClass="btn-primary" OnClick="btnAddUser_Click" />
                    ...
                    <div class="modern-table-container">
                        <asp:GridView ID="gvSchools" runat="server" AutoGenerateColumns="False" CssClass="modern-table"
                            DataKeyNames="UserId" OnRowCommand="gvSchools_RowCommand" OnRowDeleting="gvSchools_RowDeleting"
                            AllowPaging="True" PageSize="10" OnPageIndexChanging="gvSchools_PageIndexChanging"
                                ...
                                <asp:TemplateField HeaderText="Actions" ItemStyle-CssClass="actions-cell">
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            ...
                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("UserId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Edit User">
                                <i class="fas fa-edit"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("UserId") %>'
                                                CssClass="btn-action btn-delete btn-danger" ToolTip="Delete User" OnClientClick="return confirm('Are you sure you want to delete this User?');">
