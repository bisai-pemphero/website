...
public partial class AddSchool : System.Web.UI.Page
{
    ...
    public void LoadDetails(string id)
    {
        try
        {
            string sql = @"Select [Username], [Fullname], [RoleId], [SchoolId] from Users where UserId = @id";
            SqlCommand cmd = new SqlCommand(sql, appconSQL2);
            ...
            while (dr.Read())
            {
                ...
                drpRole.Text = dr.GetString(2);
                drpSchools.Text = dr.GetString(3);
   ...
   public void sendEmail()
    {
        ...
        message.Subject = "Updated School Login Details!";
  ...
  <body style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
    <div style='width: 100%; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;'>
      ...
      <div style='padding: 20px;'>
        ...
        <p>Here are the updated <strong>Login details</strong>!.</p>
