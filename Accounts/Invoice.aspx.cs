...
public partial class Invoice : System.Web.UI.Page
{
    ...
    private void BindSchoolsGrid()
    {
        try
        {
            ...
            {
                string query = @"SELECT [SchoolId], [School_name], [School_address], [Admin_name] 
                FROM [AllSchools]";
    ...
    protected void gvSchools_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Add")
        {
            ...
            Response.Redirect("InvoiceGenerate.aspx?SchoolId=" + schoolId);
        }
        if (e.CommandName == "View")
        {
            string schoolId = e.CommandArgument.ToString();
            Response.Redirect("InvoiceView.aspx?SchoolId=" + schoolId);
        }
    }
