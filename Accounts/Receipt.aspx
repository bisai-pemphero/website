    ...
    <form runat="server">
        <div class="receipt">
            ...
            <br />
                ...
                <div class="bold"><asp:Label runat="server" ID="lblSlogan"></asp:Label></div>
                <div class="bold"><asp:Label runat="server" ID="lblAddress"></asp:Label></div>
                <div class="bold"><asp:Label runat="server" ID="lblPhoneNumber"></asp:Label></div>
            </div>
            <br />
