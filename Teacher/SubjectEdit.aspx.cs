...
public partial class AddSchool : System.Web.UI.Page
{
    ...
    public void LoadAll2(string subjectId)
    {
        try
        {
            string sql3 = @"Select S.[SubjectName], S.ClassId, C.ClassName from Subjects as S
            ...
            while (dr3.Read())
            {
                ...
                drpClass.Text =  dr3.GetInt32(1) + "|" + dr3.GetString(2);
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string className = thisClass[1];
                ...
                //update subjects
                string sql = @"Update [Subjects] set [SubjectName] = @name, [ClassId] = @classId where [SubjectId] = @subjectId ";
                SqlCommand cmd = new SqlCommand(sql, appconSQL2);
                ...
                Reset();
                ScriptManager.RegisterStartupScript(this, GetType(), "ShowSuccessAlert", "showAlert('success', 'Subject Updated Successfully!')", true);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Reset();
            ScriptManager.RegisterStartupScript(this, GetType(), "ShowSuccessAlert", "showAlert('success', 'Subject Deleted Successfully!')", true);
