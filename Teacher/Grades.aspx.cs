...
public partial class UsersView : System.Web.UI.Page
{
    ...
    public void LoadGrades()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            SqlCommand command = new SqlCommand(@" Select [Id], [Grade], [Minimum_Mark], 
            [Maxmum_Mark], [Remark], [Level] from GradingSystem where 
            SchoolId = @schoolId Order by Grade ASC", connection);
            ...
            while (reader.Read())
            {
                ...
                Response.Write("<td>" + reader["Level"] + "</td>");
                Response.Write("<td>");
                Response.Write("<a href='GradeEdit.aspx?id=" + Id + "' >");
