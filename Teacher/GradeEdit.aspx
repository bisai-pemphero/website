<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeEdit.aspx.cs" Inherits="AddSchool" %>
            ...
            <main class="content">
                ...
                <div class="form-container">
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Grade" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                        <asp:Button runat="server" ID="btnEdit" CssClass="btn-warning" Text="Delete Grade" OnClick="btnEdit_Click" />
                    </div>
                </div>

                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblGradeId" Visible="false"></asp:Label>
