<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubjectAdd.aspx.cs" Inherits="AddSchool" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header"> Add Subjects </h2>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Save Subject" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                    </div>
                </div>
