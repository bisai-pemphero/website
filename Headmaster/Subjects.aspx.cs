...
SELECT  
    ...
    S.SubjectName,
    C.ClassName,
    ISNULL(U.Fullname, 'Not Allocated') AS TeacherName
FROM Subjects AS S
INNER JOIN Classes AS C 
    ON S.ClassId = C.ClassID
LEFT JOIN Users AS U 
    ON S.TeacherId = U.UserId
WHERE C.SchoolId = @schoolId", connection);
            ...
            while (reader.Read())
            {
                ...
                Response.Write("<a href='SubjectEdit.aspx?id=" + Id + "' >");
                Response.Write(" Edit</a>");
                Response.Write("</td>");
                Response.Write("<td>");

                Response.Write("<a href='SubjectAssign.aspx?id=" + Id + "' >");
                Response.Write(" Assign</a>");
                Response.Write("</td>");
                Response.Write("</tr>");
            }
