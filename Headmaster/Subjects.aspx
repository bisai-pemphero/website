<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Subjects.aspx.cs" Inherits="UsersView" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Subjects</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnAdd" runat="server" Text=" Add Subject" Font-Bold="true" CssClass="btn-primary" OnClick="btnAdd_Click" />
