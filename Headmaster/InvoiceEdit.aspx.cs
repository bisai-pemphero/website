...
public partial class InvoiceGenerate : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
            ...
            string sql5 = @"Update SchoolInvoice set [Description] =@description, 
            [Total] = @total, [Paid] =@paid, [Balance_Due] = @balance where InvoiceId = @id";
        ...
        string sql6 = @"Update SchoolPayments set Amount_Paid = @amount where InvoiceId = @invoiceId";
        SqlCommand cmd6 = new SqlCommand(sql6, appconSQL2);
        cmd6.Parameters.AddWithValue("@invoiceId", lblInvoiceId.Text.Trim());
        ...
        sendEmail();
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "ShowSuccessAlert", "showAlert('success', 'Invoice Updated Successfully!')", true);   
    }
    ...
    public void sendEmail()
    {
        ...
        message.Subject = "SCHOOL LICENCE INVOICE (UPDATED)";
    ...
    <body>
        <div class='invoice-container'>
            ...
            <div class='header'>
                <h1>School Licence Invoice Updated</h1>
            </div>
