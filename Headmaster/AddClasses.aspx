<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddClasses.aspx.cs" Inherits="AddStudent" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Add School Classes</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <!-- Changed from user to tasks -->
                                <asp:DropDownList CssClass="form-control" ID="drpUpsert" runat="server"
                                    AutoPostBack="true" OnSelectedIndexChanged="drpUpsert_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="error-message" id="action-error">Please Select Action</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <!-- Changed from venus-mars to chalkboard -->
                                <asp:TextBox CssClass="form-control" placeholder="Type new class name" ID="txtClassName" runat="server"></asp:TextBox>
                            </div>
                            <div class="error-message" id="class-error">Please Enter Class Name</div>
                        </div>

                        <!-- School Level -->
                        <div class="form-group">
                            <label class="form-label" for="Level">School Level</label>
                            <div class="input-with-icon">
                                <i class="fas fa-school"></i>
                                <!-- Changed from phone to school -->
                                <asp:DropDownList CssClass="form-control" ID="drpLevel" runat="server">
                                    ...
                                    <asp:ListItem Text="Secondary - Senior" Value="Secondary - Senior"></asp:ListItem>
                                     <asp:ListItem Text="Secondary - Junior" Value="Secondary - Junior"></asp:ListItem>
                                    <asp:ListItem Text="Tertiary" Value="Tertiary"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        ...
                        <!-- Class Section -->
                        <div class="form-group">
                            <label class="form-label" for="Section">Class Section (Optional)</label>
                            <div class="input-with-icon">
                                <i class="fas fa-layer-group"></i>
                                <!-- Changed from envelope to layer-group -->
                                <asp:TextBox ID="txtSection" runat="server" CssClass="form-control"
                                    placeholder="Enter Class Section"></asp:TextBox>
                            </div>
                    ...
                    <div class="button-container">
                        <asp:Button runat="server" ID="btnRegister" CssClass="btn-primary" Text="Save" OnClientClick="return validateForm()" OnClick="btnRegister_Click" />
                        <asp:Button runat="server" ID="btnUpdate" CssClass="btn-secondary" Text="Update" OnClientClick="return validateForm()" OnClick="btnUpdate_Click" />
                        <asp:Button runat="server" ID="btnDelete" CssClass="btn btn-warning" Text="Delete" OnClick="btnDelete_Click" />
                    </div>
                </div>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtClassName.ClientID %>').value) {
                ...
                document.getElementById('<%= drpUpsert.ClientID %>').addEventListener('input', function () {
                    document.getElementById('action-error').style.display = 'none';
                });

                document.getElementById('<%= txtClassName.ClientID %>').addEventListener('change', function () {
                    document.getElementById('class-error').style.display = 'none';
                });


                document.getElementById('<%= drpLevel.ClientID %>').addEventListener('input', function () {
