    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           string teacherName = thisTeacher[1];
            ...
            string sql3 = @"Select * from FormTeachers where [ClassId] = @classId";
            SqlCommand cmd3 = new SqlCommand(sql3, appconSQL2);
            ...
            if (dr3.HasRows)
            {
                ...
                lblError.Text = "Class Teacher already assigned to this class, please just Update!";
            ...
            else
            {
                ...
                string sql = @"Insert into FormTeachers (TeacherId, TeacherName, 
                ClassId, SchoolId) VALUES (@teacherId, @teacherName, @classId, 
                @schoolId)";
                SqlCommand cmd = new SqlCommand(sql, appconSQL2);
                ...
                Reset();
                ScriptManager.RegisterStartupScript(this, GetType(), "ShowSuccessAlert", "showAlert('success', 'Class Teacher Assigned Successfully!')", true);
            }
        }
        catch (Exception ex)
        {
