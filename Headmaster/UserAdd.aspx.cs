...
public partial class AddSchool : System.Web.UI.Page
{
    ...
    public void LoadSchools()
    {
        try
        {
            ...
            drpRole.Items.Clear();
            drpRole.Items.Add("");
            string sql3 = @"Select RoleId, RoleName from Roles where RoleId !=1 
                        AND RoleId != 2";
            ...
            string sql4 = @"Select Distinct [DistrictName] from Districts order by DistrictName";
        ...
        catch (Exception ex)
        {
            ...
            lblError.Text = "Load School error" + ex;
        }
        finally
        {
            //
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                [Fullname],[RoleId], [Created_On],[SchoolId], [Location], 
                Position) VALUES (@username, @password, @fullname, @roleId,
  ...
  <body style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
    <div style='width: 100%; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;'>
      ...
      <div style='padding: 20px;'>
        ...
        <p>If you have any questions or need assistance, feel free to contact us on WhatsApp: <strong><a href='https://wa.me/265882196556' style='color: #007BFF;'>+265 882 196 556</a></strong> or via email at <a href='mailto:inosoftmw@gmail.com'>inosoftmw@gmail.com</a>.</p>
      </div>
