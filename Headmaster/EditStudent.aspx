<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditStudent.aspx.cs" Inherits="AddStudent" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Update Student Details</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="form-control" placeholder="Select Date of Birth"></asp:TextBox>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox ID="txtAdmissionDate" runat="server" CssClass="form-control" placeholder="Select Admission Date"></asp:TextBox>
                            </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Student" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                        <asp:Button runat="server" ID="btnDelete" CssClass="btn-secondary" Text="Delete Student" OnClick="btnDelete_Click"/>
                    </div>
                </div>
                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                 <asp:Label runat="server" ID="lblParentId" Visible="false"></asp:Label> <br />
