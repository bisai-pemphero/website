    ...
    <div style='width: 100%; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;'>
      ...
      <div style='padding: 20px;'>
       <p>Dear <strong>" + Client + @"</strong>,</p>
        ...
        <p> If you have any questions or need assistance, feel free to contact us on WhatsApp: <strong><a href='https://wa.me/265882196556' style='color: #007BFF;'>+265 993 744 323</a></strong> or via email at <a href='mailto:pempherobisai@gmail.com'>Pemphero Bisai </a>.</p>
      </div>
