<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamAdd.aspx.cs" Inherits="AddSchool" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Set Exam </h2>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Save Exam" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                    </div>
                </div>
