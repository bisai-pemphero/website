...
ORDER BY t.OverallPass ASC, t.TotalMarks DESC";
                    ...
                    using (SqlCommand command = new SqlCommand(query, resultsConnection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                Response.Write("placeholder='Enter Head teachers remark here...' ");
    ...
    public static object SaveTeacherRemark(int studentId, string remark, int examId, int schoolId, string postedBy)
    {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand checkCmd = new SqlCommand(checkQuery, connection))
                {
                    ...
                    else
                    {
                        // Insert new remark
                        string insertQuery = @"
                        INSERT INTO ExamRemarksHeadTeacher 
        ...
        {
            System.Diagnostics.Debug.WriteLine("SaveHeadTeachersRemark Error: " + ex.Message + "\n" + ex.StackTrace);
