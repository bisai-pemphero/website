<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Exams.aspx.cs" Inherits="UsersView" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="Exams.aspx">Exams</a>
                </div>
                ...
                <div class="form-container">
                    ...
                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnAdd" runat="server" Text=" Set Exam" Font-Bold="true" CssClass="btn-primary" OnClick="btnAdd_Click" />
                    </div>
                    <div class="card-body">
