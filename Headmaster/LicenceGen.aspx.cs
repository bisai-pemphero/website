...
public partial class LicenceGen : System.Web.UI.Page
{
    string appconStr;
    ...
    protected void gvSchools_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Add")
        {
            ...
            Response.Redirect("LicenceNew.aspx?SchoolId=" + schoolId);
        }
        if (e.CommandName == "View")
        {
            string schoolId = e.CommandArgument.ToString();
            Response.Redirect("LicenceDetails.aspx?SchoolId=" + schoolId);
        }
    }
