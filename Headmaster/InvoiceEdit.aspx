<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceEdit.aspx.cs" Inherits="InvoiceGenerate" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container"/>
                    <h2 class="form-header">Edit Invoice</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="Description">Start Description</label>
                            <div class="input-with-icon">
                                <i class="fas fa-clipboard"></i>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" Rows="3" TextMode="MultiLine" placeholder="Enter invoice details here"></asp:TextBox>
                            </div>
                    ...
                    <div class="button-container">
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Invoice" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtTotal.ClientID %>').value.trim()) {
