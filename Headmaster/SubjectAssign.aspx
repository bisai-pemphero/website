<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubjectAssign.aspx.cs" Inherits="AddSchool" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="Subjects.aspx">Subjects</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Edit Subject </h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox runat="server" CssClass="form-control" ID="txtSubjectName" Enabled="false"></asp:TextBox>
                              
                            </div>
                            <div class="error-message" id="subject-error">Please Type Subject Name</div>
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="class"> Teachers</label>
                            <div class="input-with-icon">
                                <i class="fas fa-user"></i>
                                <asp:DropDownList class="form-control" ID="drpTeacher" runat="server"></asp:DropDownList>
                            </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Assign Subject" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                    </div>
                </div>

                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblSubjectId" Visible="false"></asp:Label>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtSubjectName.ClientID %>').value.trim()) {
