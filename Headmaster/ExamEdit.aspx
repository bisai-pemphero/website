<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamEdit.aspx.cs" Inherits="AddSchool" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="Exams.aspx">Exam</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Edit Exam </h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="subject">Exam Name</label>
                            <div class="input-with-icon">
                                <i class="fas fa-book-open"></i>
                                <asp:TextBox runat="server" CssClass="form-control" ID="txtExamName"></asp:TextBox>
                            </div>
                            <div class="error-message" id="exam-error">Please Type Exam Name</div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="subject">Start Date</label>
                            <div class="input-with-icon">
                                <i class="fas fa-calendar"></i>
                                <asp:TextBox runat="server" CssClass="form-control" ID="txtStart" TextMode="Date"></asp:TextBox>
                            </div>
                            <div class="error-message" id="start-error">Please enter exam start date</div>
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="subject">End Date</label>
                            <div class="input-with-icon">
                                <i class="fas fa-calendar"></i>
                                <asp:TextBox runat="server" CssClass="form-control" ID="txtEnddate" TextMode="Date"></asp:TextBox>
                            </div>
                            <div class="error-message" id="end-error">Please enter exam End date</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpAcademicYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpAcademicYear_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="academic-error">Please Select academic Year </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpTerm" runat="server"></asp:DropDownList>
                            </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Exam" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                        <asp:Button runat="server" ID="btnEdit" CssClass="btn-warning" Text="Delete Exam" OnClick="btnEdit_Click"/>
                    </div>
                </div>

                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblExamId" Visible="false"></asp:Label>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtExamName.ClientID %>').value.trim()) {
                    document.getElementById('name-error').style.display = 'block';
                    isValid = false;
                }

                if (!document.getElementById('<%= txtStart.ClientID %>').value.trim()) {
