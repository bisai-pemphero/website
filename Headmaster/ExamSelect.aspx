<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExamSelect.aspx.cs" Inherits="AddSchool" %>
    ...
    <form id="form1" runat="server">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpTerm" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpTerm_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpExam" runat="server"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="exam-error">Please Select Exam </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="Class">Class</label>
                            <div class="input-with-icon">
                                <i class="fas fa-building"></i>
                                <asp:DropDownList class="form-control" ID="drpClass" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpClass_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpSubject" runat="server"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="subjet-error">Please Select Subject </div>
                        </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnNext" CssClass="btn-primary" Text="Next" OnClick="btnNext_Click"  OnClientClick="return validateForm()" />
                    </div>
                </div>

                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblTeacherId" Visible="false"></asp:Label>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= drpExam.ClientID %>').value.trim()) {
                    document.getElementById('exam-error').style.display = 'block';
                    isValid = false;
                }

                if (!document.getElementById('<%= drpSubject.ClientID %>').value.trim()) {
