<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ClassTeacher.aspx.cs" Inherits="UsersView" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="ClassTeacher.aspx">Class Teachers</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Class Teachers</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnAdd" runat="server" Text=" Add Class Teacher" Font-Bold="true" CssClass="btn-primary" OnClick="btnAdd_Click" />

                    </div>
                    <div class="card-body">
                        <table id="staffTable" class="modern-table">
                            <thead>
                                <tr>
                                    <th>Teacher</th>
                                    <th>Class</th>
