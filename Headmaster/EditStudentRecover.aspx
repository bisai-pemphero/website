<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditStudentRecover.aspx.cs" Inherits="AddStudent" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Recover Deleted Student</h2>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Recover Student" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
