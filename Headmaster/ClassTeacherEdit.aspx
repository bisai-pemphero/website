<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassTeacherEdit.aspx.cs" Inherits="EditFormTeacher" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="ClassTeacher.aspx">Class Teacher</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Update Class Teacher</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList runat="server" CssClass="form-control" ID="drpTeacher"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="teacher-error">Please select Teacher</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList class="form-control" ID="drpClass" runat="server"></asp:DropDownList>
                            </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Class Teacher" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                        <asp:Button runat="server" ID="btnDelete" CssClass="btn-warning" Text="Delete Class Teacher" OnClick="btnDelete_Click" />

                    </div>
                </div>

                <asp:Label runat="server" ID="lblSchoolId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblFormTeacherId" Visible="false"></asp:Label>
        ...
        <script>
            ...
            document.querySelectorAll('.btn-danger').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    Swal.fire({
                        title: 'Delete Form Teacher?',
                        html: `You're about to delete <strong>a Form Teacher</strong>`,
                        icon: 'warning',
                        showCancelButton: true,
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire(
                                'Deleted!',
                                'The Form Teacher has been deleted.',
                                'success'
                            );
                        }
                    });
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= drpTeacher.ClientID %>').value.trim()) {
