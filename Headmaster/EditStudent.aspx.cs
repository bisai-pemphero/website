...
public partial class AddStudent : System.Web.UI.Page
{
    ...
    {
        //delete student here
        string sql4 = @"Update Students set [IsDeleted] = 1, 
        [UpdatedAt] = GETDATE() where [StudentID] = @studentId";
        SqlCommand cmd4 = new SqlCommand(sql4, appconSQL2);
        cmd4.Parameters.AddWithValue("@studentId", lblStudentId.Text.Trim());
        cmd4.ExecuteNonQuery();
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "ShowSuccess", "showAlert('success', 'Student Deleted successfully!', 'ViewStudent.aspx');", true);
