<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RecoverStudent.aspx.cs" Inherits="ViewStudent" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="ViewStudent.aspx">Students</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Recover Deleted Students</h2>

                    <asp:Label runat="server" ID="lblError" CssClass="toast-error" Font-Bold="true" ForeColor="Red" Font-Size="Large"></asp:Label>

                    <div class="button-container" style="margin-bottom: 20px;">
                        <asp:Button ID="btnBack" runat="server" Text=" Back to List" CssClass="btn-primary" OnClick="btnBack_Click" />
