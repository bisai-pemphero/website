            ...
            <main class="content">
                ...
                <div class="form-container">
                    ...
                    <div class="button-container" style="margin-bottom: 20px;">
                        ...
                        <asp:Button ID="btnDeleted" runat="server" Text=" Recover Student" class="btn btn-warning" OnClick="btnDeleted_Click" />
                         <asp:Button ID="btnChangeClass" runat="server" Text=" Change Student Class" class="btn btn-success" OnClick="btnChangeClass_Click" />       
                    </div>
                          <!-- Table here  -->
                          <div class="card-body">
