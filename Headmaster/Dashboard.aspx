        ...
        <div class="app">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <nav class="nav">
                    ...
                    <div class="dropdown">
                        <a href="BalanceFees.aspx"><i class="fa-solid fa-bank"></i>Fees</a>
                        <div class="dropdown-menu">
                            <a href="BalanceFees.aspx">Fees Balances</a>
                            <a href="CompletedFees.aspx">Completed Balances</a>
                        </div>
                    </div>
                    <div class="dropdown">
                        <a href="UsersView.aspx"><i class="fa-solid fa-users"></i>Staff</a>
                        <div class="dropdown-menu"><a href="UsersView.aspx">System Users</a> </div>
                    </div>
                    <div class="dropdown">
                        <a href="AddClasses.aspx">
                            <i class="fa-solid fa-chalkboard"></i>Classes</a>
                        <div class="dropdown-menu">
                            <a href="AddClasses.aspx">Add Class</a>
                            <a href="ChangeClass.aspx">Change Student Class</a>
                            <a href="ClassTeacher.aspx">Class Teacher</a>
                        </div>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="Exams.aspx">Set Exam</a>
                             <a href="Grades.aspx">Grading System</a>
                              <a href="ExamSelect.aspx">Mark Exam</a>
                             <a href="ExamFinal.aspx" runat="server"> Marked Subjects</a>
                              <a href="ExamRemarkSelect.aspx" runat="server" >Exam Remarks</a>  
                            <a href="ExamResults.aspx" runat="server" >Exam Results</a>
                        </div>
                    </div>

                    <div class="dropdown">
                        <a href="AcademicYear.aspx">
                            <i class="fa-solid fa-calendar"></i>Academic Year</a>
                        <div class="dropdown-menu">
                            <a href="AcademicYear.aspx">Academic Year</a>
                            <a href="AcademicTerm.aspx">Term</a>
                        </div>
                    </div>
                </nav>
            </aside>
