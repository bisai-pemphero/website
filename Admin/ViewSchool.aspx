<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ViewSchool.aspx.cs" Inherits="AddSchool" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">View Schools</h2>
                    ...
                    <div class="button-container" style="margin-bottom: 20px;">
                        ...
                        <asp:Button ID="btnExport" runat="server" Text="Save as Pdf" Font-Bold="true" CssClass="btn-secondary" OnClick="btnExport_Click" />
                        </div>
                    <!--schoolDetails -->
                    ...
                    <div class="modern-table-container">
                        <asp:GridView ID="gvSchools" runat="server" AutoGenerateColumns="False" CssClass="modern-table"
                            DataKeyNames="SchoolId" OnRowCommand="gvSchools_RowCommand" OnRowDeleting="gvSchools_RowDeleting"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="School_address" HeaderText="Address" />
                                <asp:BoundField DataField="Admin_name" HeaderText="Admin" />
                                <asp:TemplateField HeaderText="Actions" ItemStyle-CssClass="actions-cell">
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            <asp:LinkButton ID="btnView" runat="server" CommandName="View" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="View Details" OnClientClick='<%# "showSchoolDetails(\"" + Eval("SchoolId") + "\"); return false;" %>'>
    <i class="fas fa-eye"></i>
                                            </asp:LinkButton>


                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Edit Details">
                                <i class="fas fa-edit"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-delete btn-danger" ToolTip="Delete School" OnClientClick="return confirm('Are you sure you want to delete this school?');">
