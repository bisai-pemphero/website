<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolDetails.aspx.cs" Inherits="AddSchool" %>
...
<body>
    ...
    <div class="card-header">
        ...
        <div class="school-title">
            <h3><asp:Literal ID="litSchoolName" runat="server"></asp:Literal></h3>
            <p class="slogan"><asp:Literal ID="litSlogan" runat="server"></asp:Literal></p>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="details-grid">
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-envelope"></i> School Email</span>
                <p class="detail-value"><asp:Literal ID="litSchoolEmail" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-phone"></i> Phone Number</span>
                <p class="detail-value"><asp:Literal ID="litPhoneNumber" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-map-marker-alt"></i> Address</span>
                <p class="detail-value"><asp:Literal ID="litSchoolAddress" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-user-tie"></i> Admin Name</span>
                <p class="detail-value"><asp:Literal ID="litAdminName" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-envelope"></i> Admin Email</span>
                <p class="detail-value"><asp:Literal ID="litAdminEmail" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-mobile-alt"></i> Admin Phone</span>
                <p class="detail-value"><asp:Literal ID="litAdminPhone" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-calendar-alt"></i> Date Registered</span>
                <p class="detail-value"><asp:Literal ID="litDateRegistered" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-user-plus"></i> Registered By</span>
                <p class="detail-value"><asp:Literal ID="litRegisteredBy" runat="server"></asp:Literal></p>
            </div>
        </div>
    </div>
</div>
