<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addsms.aspx.cs" Inherits="InvoiceGenerate" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Add sms</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="Charge">Quantity</label>
                            <div class="input-with-icon">
                                <i class="fas fa-dollar"></i>
                                <asp:TextBox ID="txtTotal" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                            </div>
                            <div class="error-message" id="total-error">Please enter Quantity</div>
                        </div>
                    </div>
