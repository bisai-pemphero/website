<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PaymentView.aspx.cs" Inherits="Payment" %>
                ...
                <div class="form-container">
                    ...
                    <div class="modern-table-container">
                        <asp:GridView ID="gvSchools" runat="server" AutoGenerateColumns="False" CssClass="modern-table"
                            DataKeyNames="PaymentId" OnRowCommand="gvSchools_RowCommand"
                                ...
                                <asp:TemplateField HeaderText="Actions" ItemStyle-CssClass="actions-cell">
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            ...
                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("PaymentId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Edit Payment">
