<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LicenceDetails.aspx.cs" Inherits="LicenceDetails" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="LicenceDetails.aspx">Licence Details</a>
                </div>
    ...
    <div class="card-body">
        <div class="details-grid">
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-bookmark"></i> Status</span>
                <p class="detail-value"><asp:Literal ID="litStatus" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-area-chart"></i> Mode</span>
                <p class="detail-value"><asp:Literal ID="litMode" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-calendar"></i> Start Date</span>
                <p class="detail-value"><asp:Literal ID="litStart" runat="server"></asp:Literal></p>
            </div>
            
            <div class="detail-group">
                <span class="detail-label"><i class="fas fa-calendar"></i> Expiry Date</span>
                <p class="detail-value"><asp:Literal ID="litExpiry" runat="server"></asp:Literal></p>
            </div>
