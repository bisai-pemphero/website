<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pay.aspx.cs" Inherits="InvoiceGenerate" %>
        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="button-container">
                    <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Make Payment" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                ...
                <asp:Label runat="server" ID="lblInvoiceId" Visible="false"></asp:Label>
