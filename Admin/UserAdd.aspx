<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAdd.aspx.cs" Inherits="AddSchool" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <nav class="nav">
                    ...
                    <div class="dropdown">
                        <a class="active" href="UsersView.aspx"><i class="fa-solid fa-user"></i>Users</a>
                        <div class="dropdown-menu">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="UsersView.aspx">Users</a>
                </div>

                <div class="form-container">
                    <h2 class="form-header">Register User</h2>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox ID="txtUserEmail" runat="server" CssClass="form-control" placeholder="Enter User Email" TextMode="Email"></asp:TextBox>
                            </div>
                            <div class="error-message" id="user-email-error">Please enter a valid User Email</div>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox ID="txtFullname" runat="server" CssClass="form-control" placeholder="Enter Fullname"></asp:TextBox>
                            </div>
                            <div class="error-message" id="fullname-error">Please enter Fullname</div>
                        </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="role">Users Role</label>
                            <div class="input-with-icon">
                                <i class="fas fa-gear"></i>
                                <asp:DropDownList class="form-control" ID="drpRole" runat="server"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="role-error">Please select Users role</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList runat="server" ID="drpSchools" CssClass="form-control"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="schools-error">Please select school </div>
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:DropDownList runat="server" ID="drpLocation" CssClass="form-control"></asp:DropDownList>
                            </div>
                            <div class="error-message" id="location-error">Please enter Users location</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <asp:TextBox ID="txtPosition" runat="server" CssClass="form-control" placeholder="Enter Job Title "></asp:TextBox>

                            </div>
                            <div class="error-message" id="position-error">Please enter users Position</div>
                        </div>
                    </div>
                    ...
                    <div class="button-container">
                        ...
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Register User" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                    </div>
                </div>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= txtUserEmail.ClientID %>').value.trim()) {
                    document.getElementById('user-email-error').style.display = 'block';
                    isValid = false;
                }
                if (!document.getElementById('<%= txtPosition.ClientID %>').value.trim()) {
                    document.getElementById('position-error').style.display = 'block';
                    isValid = false;
                }
                if (!document.getElementById('<%= drpRole.ClientID %>').value.trim()) {
                    document.getElementById('role-error').style.display = 'block';
                    isValid = false;
                }
                if (!document.getElementById('<%= drpLocation.ClientID %>').value.trim()) {
                    document.getElementById('location-error').style.display = 'block';
                    isValid = false;
                }
                if (!document.getElementById('<%= drpSchools.ClientID %>').value.trim()) {
