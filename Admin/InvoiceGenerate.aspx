        ...
        <div class="app">
            ...
            <main class="content">
                ...
                <div class="form-container">
                    <h2 class="form-header">Generate Invoice</h2>
                    ...
                    <div class="button-container">
                        <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Save Invoice" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
