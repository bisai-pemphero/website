...
public partial class InvoiceAllDetail : System.Web.UI.Page
{
    string appconStr;
    ...
    {
        string query = @"SELECT AL.[SchoolId], AL.[School_name], 
                        AL.[School_address], AL.[Slogan], AL.[Logo], AL.[Admin_name], SI.Description, 
                        SI.Total, SI.[Paid] FROM [AllSchools] as AL 
					    Join SchoolInvoice as SI on SI.SchoolId = AL.SchoolId
        ...
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["Myschools"].ConnectionString))
        {
            using (SqlCommand cmd = new SqlCommand(query, conn))
            {
                ...
                if (reader.Read())
                {
                    ...
                    litTotal.Text = "K" + reader["Total"].ToString();
                    litPaid.Text = "K" + reader["Paid"].ToString();
