                ...
                while (dr0.Read())
                {
                  ...
                  dr0.Close();
                   ...
                   VALUES (@key, @status, @mode, @schoolId, @email, @date1, @Expiry, @user, GETDATE())";
                            ...
                            //Insert into sms
                            string sqlSms = @"Insert into sms ([SchoolId],[Purchased],
                            [Used],[Balance])  VALUES (@schoolId, 0,0,0)";
                            SqlCommand cmdsms = new SqlCommand(sqlSms, appconSQL2);
                            cmdsms.Parameters.AddWithValue("@schoolId", lblSchoolId.Text.Trim());
