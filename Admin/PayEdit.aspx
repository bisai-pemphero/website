<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayEdit.aspx.cs" Inherits="InvoiceGenerate" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="InvoiceGenerate.aspx">Invoice</a>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" placeholder="Enter invoice details here" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="error-message" id="description-error">Please enter Invoice description </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="Charge">Amount</label>
                        <div class="input-with-icon">
                            <i class="fas fa-dollar"></i>
                            <asp:TextBox ID="txtTotal" runat="server" CssClass="form-control" TextMode="Number" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="error-message" id="total-error">Please enter amount</div>
                    </div>
                </div>
                <div class="form-grid">
                    <!-- another here -->
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <asp:DropDownList runat="server" ID="drpPaymentMode" CssClass="form-control">
                                <asp:ListItem Value="" Text=""></asp:ListItem>
                                <asp:ListItem Value="Cash" Text="Cash"></asp:ListItem>
                                <asp:ListItem Value="Bank Transfer" Text="Bank Transfer"></asp:ListItem>
                                <asp:ListItem Value="Mobile Money" Text="Mobile Money"></asp:ListItem>
                            </asp:DropDownList>

                        </div>
                        <div class="error-message" id="payment-mode-error">Please Select Payment Mode </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="Reference">Reference</label>
                        <div class="input-with-icon">
                            <i class="fas fa-comment"></i>
                            <asp:TextBox ID="txtReference" runat="server" CssClass="form-control" Placeholder="Payment reference"></asp:TextBox>
                        </div>
                ...
                <div class="button-container">
                    <asp:Button runat="server" ID="btnSave" CssClass="btn-primary" Text="Update Payment" OnClick="btnSave_Click" OnClientClick="return validateForm()" />
                ...
                <asp:Label runat="server" ID="lblPaymentId" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblSchoolName" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblSchoolEmail" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblSchoolAdmin" Visible="false"></asp:Label>

                <asp:Label runat="server" ID="lblSchoolAddress" Visible="false"></asp:Label>
                <asp:Label runat="server" ID="lblSchoolContact" Visible="false"></asp:Label>
            </main>
        ...
        <script>
            ...
            function validateForm() {
                ...
                if (!document.getElementById('<%= drpPaymentMode.ClientID %>').value.trim()) {
                    document.getElementById('payment-mode-error').style.display = 'block';
                    isValid = false;
                }
