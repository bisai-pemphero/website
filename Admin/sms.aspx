<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="sms.aspx.cs" Inherits="Invoice" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="sms.aspx">Sms</a>
                </div>
                <div class="form-container">
                    <h2 class="form-header">SMS</h2>
                                    ...
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            ...
                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Add" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Update Sms">
