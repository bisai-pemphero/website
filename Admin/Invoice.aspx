<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Invoice.aspx.cs" Inherits="Invoice" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="Invoice.aspx">Generate Invoice</a>
                </div>
                <div class="form-container">
                    <h2 class="form-header">Invoice</h2>
                    ...
                    <div class="modern-table-container">
                        <asp:GridView ID="gvSchools" runat="server" AutoGenerateColumns="False" CssClass="modern-table"
                            DataKeyNames="SchoolId" OnRowCommand="gvSchools_RowCommand"
                                    ...
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            <asp:LinkButton ID="btnView" runat="server" CommandName="View" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="View Invoices" OnClientClick='<%# "showSchoolDetails(\"" + Eval("SchoolId") + "\"); return false;" %>'>
                                                    <i class="fas fa-eye"></i>
                                            </asp:LinkButton>

                                            <asp:LinkButton ID="bntEdit" runat="server" CommandName="Add" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="Generate Invoice">
