<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Payments.aspx.cs" Inherits="Payments" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="app">
            ...
            <main class="content">
                <div class="crumbs">
                    <i class="fa-solid fa-school"></i><a href="Dashboard.aspx">Dashboard</a> <i class="fa-solid fa-angle-right"></i><a href="Payments.aspx">Payments</a>
                </div>
                <div class="form-container">
                    <h2 class="form-header">Payments</h2>
                                    ...
                                    <ItemTemplate>
                                        <div class="action-buttons">
                                            <asp:LinkButton ID="btnView" runat="server" CommandName="View" CommandArgument='<%# Eval("SchoolId") %>'
                                                CssClass="btn-action btn-view" ToolTip="View Payments" OnClientClick='<%# "showSchoolDetails(\"" + Eval("SchoolId") + "\"); return false;" %>'>
